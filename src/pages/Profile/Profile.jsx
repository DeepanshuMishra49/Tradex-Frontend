            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Deepanshu Mishra"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date Of Birth : </p>
                  <p className="text-gray-500">{"27/08/2004"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"Ghaziabad"} </p>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{201002} </p>
                </div>
                <div className="flex">
